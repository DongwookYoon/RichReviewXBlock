/* eslint-disable camelcase,no-var,no-console,prefer-const,no-unused-vars,prettier/prettier,no-undef,no-lone-blocks,no-redeclare,no-throw-literal,new-cap,standard/computed-property-even-spacing,no-use-before-define,handle-callback-err,no-unreachable,no-self-assign */
/**
...
;(function(r2) {
  ...
  r2.log = (function() {
    ...
    const upload = function(logs) {
      return r2.util.postToDbsServer('WebAppLogs', {
